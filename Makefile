...
Makefile.conf: _CoqProject
	coq_makefile -f _CoqProject Library/DistState/CoreDef.v Library/DistState/Arithmetic.v Library/DistState/Support.v Library/DistState/ValidDst.v Library/DistState/Combine.v Library/DistState/Bulid.v Library/DistState/Partial.v Library/DistState/Restrict.v Library/DistState/Domain.v Library/Assertion/Asserts.v Library/Assertion/SemProp.v Library/PIMP/EvalProps.v Library/PIMP/Syntax.v Library/PIMP/Semantics.v Library/UtilityQR.v Example/Bays.v Example/Prog1.v Rule/HoareLogic.v -o Makefile
